...
namespace MandelbrotSetWinForms
{
    public class ZFunction
    {
        ...
        public static ZFunction operator +(ZFunction ZN, int number)
        {
            return new ZFunction(ZN.ZValue + number);
        }
        public static ZFunction operator +(ZFunction ZN, ComplexNumber i)
        {
            return new ZFunction(ZN.ZValue + i);
        }
