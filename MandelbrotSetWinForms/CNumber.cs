...
namespace MandelbrotSetWinForms
{
    public class CNumber
    {
        ...
        public static CNumber operator +(CNumber c1, int num)
        {
            return new CNumber(c1.X + num, c1.Y);
        }
        public static CNumber operator +(CNumber c1, ComplexNumber i)
        {
            return new CNumber(c1.X, c1.Y + 1);
        }
    }
}